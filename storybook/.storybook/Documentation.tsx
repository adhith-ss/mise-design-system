...
const guidance: Record<string, {anatomy:string; keyboard:string; usage:string}> = {
  ...
  Patterns:{anatomy:'Composed regions from DLS primitives — headers, fields, comparisons, status banners, actions and optional Plato identity.',keyboard:'Same as composed controls: Tab order through fields and actions; Escape closes dialogs; polite live regions announce saves without stealing focus. Respect reduced motion and Pause motion.',usage:'Reproduce app copy and guards exactly. Require acknowledgement and reasons where the workflow demands them. Celebrate only after a confirmed save. Never claim live sources or persistence this session does not have.'},
