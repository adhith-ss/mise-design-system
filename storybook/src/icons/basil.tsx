...
// Mise DLS pruned set — glyphs used in the app plus a small reserve for agent-first interaction.
...
export const ArrowLeft=icon('arrow-right-outline',180);
export const ArrowRight=icon('arrow-right-outline',0);
...
export const ChevronLeft=icon('caret-left-outline',0);
...
export const Copy=icon('copy-outline',0);
export const Download=icon('download-outline',0);
export const Edit=icon('edit-outline',0);
export const Ellipsis=icon('other-1-outline',0);
export const Eye=icon('eye-outline',0);
export const FileText=icon('document-outline',0);
export const Filter=icon('filter-outline',0);
export const Gauge=icon('dialpad-outline',0);
export const History=icon('history-outline',0);
export const Info=icon('info-circle-outline',0);
export const List=icon('rows-outline',0);
export const Lock=icon('lock-outline',0);
export const Package=icon('box-outline',0);
export const Pause=icon('pause-outline',0);
export const Phone=icon('phone-outline',0);
export const PieChart=icon('chart-pie-outline',0);
export const Play=icon('play-outline',0);
export const Plus=icon('plus-outline',0);
export const Receipt=icon('invoice-outline',0);
export const Refresh=icon('refresh-outline',0);
export const Search=icon('search-outline',0);
export const Send=icon('send-outline',0);
...
export const Star=icon('star-outline',0);
export const Tag=icon('bookmark-outline',0);
export const Trash=icon('trash-outline',0);
...
export const Upload=icon('upload-outline',0);
export const User=icon('user-outline',0);
...
export const XCircle=icon('cross-solid',0);
