...
const meta = {
  title: 'MVP Pilot/Data Input/Date Input',
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Archived · MVP Pilot (0.1.0). Reference only. Use 0.2.0 components. A delivery date, an invoice date, a period. Native picker, so the platform\'s locale and keyboard behaviour apply rather than a bespoke calendar the operator has to learn. Range mode binds the two inputs so the end can never precede the start.',
      },
    },
  },
