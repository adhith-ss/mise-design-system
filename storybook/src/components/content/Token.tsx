  ...
  return (
    <span
      className={cx(
        ...
        size === 'sm' ? 'px-[6px] py-[1px] text-[13px]' : 'px-[7px] py-[2px] text-[13px]',
    ...
    >
      ...
      {children}
      {onRemove && (
        <button type="button" onClick={onRemove} aria-label={`Remove ${children}`} className="text-[13px] leading-none">
